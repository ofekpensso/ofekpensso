<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=250&section=header&text=Hi,%20I'm%20Ofek!&fontSize=70&fontAlignY=35&animation=twinkling&fontColor=ffffff" width="100%"/>
</div>
...
- ☁️ Extensive experience with **AWS Cloud Environments** & **Kubernetes** orchestration.
- 🏗️ Strong believer in **Infrastructure as Code (IaC)** and automation using **Terraform** and **Ansible**.
- 🔄 Proficient in GitOps workflows using **Argo CD**.
- 🐍 Passionate about building self-service internal tools with **Python** & Platform Engineering principles.
- 🎓 Graduate of the highly intensive DevOps course at **Nitzanim to Tech**.
- 🎯 Currently focusing on advanced cloud architecture and expanding my knowledge in observability.
