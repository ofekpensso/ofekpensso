 <img src="https://via.placeholder.com/800x200/000000/FFFFFF/?text=Hi,+I'm+Ofek!" alt="Banner">

<h1 align="center">Hi, I'm Ofek!</h1>
<h3 align="center">DevOps</h3>

Passionate about building highly available, scalable, and secure cloud infrastructure. I bridge the gap between development and operations using modern Cloud Native technologies and automation.

## 🛠️ About Me

- ☁️ Experience with **AWS Cloud Environments** & **Kubernetes** orchestration.
- 🏗️ Strong believer in **Infrastructure as Code (IaC)** and automation using **Ansible**.
- 🐍 Passionate about building self-service internal tools with **Python**.
- 🎓 Graduate of the DevOps course at **Nitzanim to Tech**.
- 🌱 Currently expanding my knowledge in advanced DevOps practices and cloud architecture.
